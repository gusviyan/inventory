...
<html lang="en">
<head>
	<title>LOGIN | INVENTORY IT</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?= base_url('assets/login/') ?>images/komputer.png');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Data Iventory IT<br>
					<p style="color: white;">RS Permata Pamulang</p>
				</span>
...
<br><center><p>Developed by <a href='#' title='' target='_blank'>Gusviyan</a></p></center>
